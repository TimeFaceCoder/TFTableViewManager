...
- (ASButtonNode *)selectNode {
    if (!_selectNode) {
        ...
        [_selectNode setImage:[UIImage imageNamed:@"contactNotSelect"] forState:UIControlStateNormal];
        [_selectNode setImage:[UIImage imageNamed:@"contactSelected"] forState:UIControlStateSelected];
...
- (ASImageNode *)avatarNode {
    if (!_avatarNode) {
        ...
        _avatarNode.style.preferredSize = CGSizeMake(40.0, 40.0);
    }
    return _avatarNode;
}
