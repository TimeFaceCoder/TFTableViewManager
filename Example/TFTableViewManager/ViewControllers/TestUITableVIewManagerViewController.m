...
- (void)viewDidLoad {
    ...
    for (NSString *sectionTitle in sectionTitles) {
        ...
        section.reuseHeaderViewClass = [TestSectionHeaderView class];
        section.reuseHeaderViewReloadBlock = ^(TFTableViewSection *section, TestSectionHeaderView *headerFooterView, NSInteger sectionIndex) {
            headerFooterView.title  = sectionTitle;
        };
        section.headerHeight = 30.0;
